...
#CAPSPATH=/home/hjb/caps-2nd-review/test/ns-allinone-2.35/ns-2.35/ns
...
echo " "
echo "sfnum=10"
$CAPSPATH ./many-to-one.tcl 40 10 3 256 16 0.11 0.110004 16 0 >result
./FCT.sh
...
echo "sfnum=30"
$CAPSPATH ./many-to-one.tcl 40 30 3 256 16 0.1056 0.10560004 16 35  >result
./FCT.sh
...
echo "sfnum=40"
$CAPSPATH ./many-to-one.tcl 40 40 3 256 20 0.104 0.104004 4 1  >result
./FCT.sh
...
echo "sfnum=50"
$CAPSPATH ./many-to-one.tcl 40 50 3 256 20 0.104 0.1045 4 1  >result
./FCT.sh
...
echo "sfnum=60"
$CAPSPATH ./many-to-one.tcl 40 60 3 256 15 0.105 0.10550001 2 1  >result
./FCT.sh
...
echo "sfnum=70"
$CAPSPATH ./many-to-one.tcl 40 70 3 256 10 0.10554 0.1056 2 1  >result
./FCT.sh
...
echo "sfnum=80"
$CAPSPATH ./many-to-one.tcl 40 80 3 256 10 0.1055 0.105550004 4 1  >result
./FCT.sh
