...
echo " "
echo "sfnum=10"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 10 3 256 50 0.1101 0.1102 10 2 >result
./FCT.sh
...
echo "sfnum=20"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 20 3 256 50 0.1101 0.1102 10 2 >result
./FCT.sh
...
echo "sfnum=30"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 30 3 256  50 0.1101 0.1102 10 2  >result
./FCT.sh
...
echo "sfnum=40"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 40 3 256  50 0.1101 0.1102 10 2 >result
./FCT.sh
...
echo "sfnum=50"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 50 3 256  50 0.1101 0.1102 10 2  >result
./FCT.sh
...
echo "sfnum=60"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 60 3 256  50 0.1101 0.1102 10 2  >result
./FCT.sh
...
echo "sfnum=70"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 70 3 256  50 0.1101 0.1102 10 2 >result
./FCT.sh
...
echo "sfnum=80"
../ns-allinone-2.35/ns-2.35/ns ./many-to-many.tcl 40 80 3 256  50 0.1101 0.1102 10 2  >result
./FCT.sh
